...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
         /* Tracking the lemonadeState. When the the image is clicked, we either
         * change state to the next step in the lemonade making progression
         * or at least make some changes to the current state in the case of squeezing the lemon.
         */
        when(lemonadeState){
            ...
            SQUEEZE -> { squeezeCount++; lemonSize--; if(lemonSize==0) lemonadeState = DRINK; lemonSize = -1 }
    ...
    private fun setViewElements() {
        ...
        /*
        * for each state, the textAction TextView/lemonImage should be set to the corresponding string/drawable from the string resources file.
        * The strings/drawable are named to match the state.
        */
        when(lemonadeState){
